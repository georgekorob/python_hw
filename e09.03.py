...
posit = Position('Chuck', 'Berry', 'Singer', 10, 50)
posit2 = Position('Ron', 'Wisley', 'Student', 1, 0)
print(posit.position)
print(posit._income)
print(f'{posit.get_full_name()} {posit.get_total_income()}')
print(posit2.position)
print(posit2._income)
print(f'{posit2.get_full_name()} {posit2.get_total_income()}')
